      ...
      <div className="eco-form-container bg-black shadow-lg rounded-xl p-6 md:p-10 flex flex-col lg:flex-row lg:space-x-10 max-w-7xl mx-auto mb-8">
        ...
        <div className="eco-form-left lg:w-1/2 mb-8 lg:mb-0">
          ...
          <a
            ...
            className="text-[#b8860b] hover:underline font-medium mb-6 block text-center underline"
          >
            View on Google Maps
          </a>
          ...
          <div className="eco-contact-info space-y-6">
            ...
            <div className="eco-info-box flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-[#b8860b]">Eco Bambo, Karkhane wali abadi, Near PSO pump petrol, Nazd Ali Niaz Sweet, Chakian, Phularwan, Bhalwal 40410, Pakistan</p>
              </div>
            </div>
            ...
            <div className="eco-info-box flex items-start space-x-3">
              ...
              <div>
                ...
                <p><a href="mailto:ecobambooarts@gmail.com" className="text-[#b8860b] hover:underline underline">ecobambooarts@gmail.com</a></p>
              </div>
            </div>
            ...
            <div className="eco-info-box flex items-start space-x-3">
              ...
              <div>
                ...
                <p><a href="tel:+923416995870" className="text-[#b8860b] hover:underline underline">+92 (3416995870)</a></p>
              </div>
            </div>
            ...
            <div className="eco-info-box flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-[#b8860b]">Mon– to –Sun: 8:00 AM – 6:00 PM</p>
                <p className="text-[#b8860b]"><i className="fas fa-times-circle text-red-500 mr-1"></i>Friday: Closed</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="eco-form-right lg:w-1/2">
          ...
          <form method="post" action="/contact#contact_form" id="contact_form" acceptCharset="UTF-8" className="space-y-4">
            ...
            <input type="text" name="contact[first_name]" placeholder="First Name*" required className="w-full bg-[#181818] text-white border border-[#333] rounded px-4 py-2 mb-2 focus:outline-none focus:border-amber-400 placeholder:text-white" />
            <input type="text" name="contact[last_name]" placeholder="Last Name*" required className="w-full bg-[#181818] text-white border border-[#333] rounded px-4 py-2 mb-2 focus:outline-none focus:border-amber-400 placeholder:text-white" />
            <input type="text" name="contact[location]" placeholder="Your Location*" required className="w-full bg-[#181818] text-white border border-[#333] rounded px-4 py-2 mb-2 focus:outline-none focus:border-amber-400 placeholder:text-white" />
            <input type="text" name="contact[phone]" placeholder="Phone Number*" required className="w-full bg-[#181818] text-white border border-[#333] rounded px-4 py-2 mb-2 focus:outline-none focus:border-amber-400 placeholder:text-white" />
            <input type="email" name="contact[email]" placeholder="Email*" required className="w-full bg-[#181818] text-white border border-[#333] rounded px-4 py-2 mb-2 focus:outline-none focus:border-amber-400 placeholder:text-white" />

            <select name="contact[collection]" required className="w-full bg-[#181818] text-[#b8860b] border border-[#333] rounded px-4 py-2 mb-2 focus:outline-none focus:border-amber-400">
        ...
        <div className="footer__content-top max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 items-start">
          ...
          <div className="footer-block">
            ...
            <ul className="footer-block__details-content list-none p-0">
              <li><Link href="/collections/bamboo-canopy-in-pakistan/Canopy" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Bamboo Canopy Bliss</Link></li>
              <li><Link href="/collections/bamboo-house-luxury/House" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Bamboo House Retreat</Link></li>
              <li><Link href="/collections/bamboo-shades-for-carports-ceiling-design-elegant-solutions-of-car-vigo-for-you/garage" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Bamboo Carport Haven</Link></li>
              <li><Link href="/collections/premium-bamboo-gazebo/Gazebo" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Bamboo Gazebo Escape</Link></li>
              <li><Link href="/collections/bamboo-wall-designs/Walls" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Bamboo Wall Panels - Decor</Link></li>
            </ul>
          </div>
          ...
          <div className="footer-block">
            ...
            <ul className="footer-block__details-content list-none p-0">
              <li><Link href="/collections/premium-bamboo-lounge-set-with-cushioned-seating-modern-outdoor-indoor-comfort" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Luxury Sofa Set</Link></li>
              <li><a href="https://ecobambo.com/collections/bamboo-single-kid-bed" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Bamboo luxe Beds</a></li>
              <li><Link href="/collections/premium-bamboo-dining-sets/Chair-&-Table-Set" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Bamboo Chair Corner</Link></li>
              <li><Link href="/collections/explore-the-best-bamboo-hanging-chairs-swing-garden-swings-and-rocking-swings-for-every-space/Swings" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Bamboo Family Swings</Link></li>
              <li><a href="https://ecobambo.com/collections" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">All Eco Bamboo Collections</a></li>
            </ul>
          </div>
          ...
          <div className="footer-block">
            ...
            <ul className="footer-block__details-content list-none p-0">
              <li><Link href="/collections/eco-friendly-bamboo-kids-beds-perfect-for-children/Baby-Beds" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Baby Bamboo Beds - Cribs</Link></li>
              <li><Link href="/collections/1-modern-bamboo-hanging-wall-art-standing-plant-and-flower-pot-stylish-decor-perfect-for-home-garden/Hanging-Walls" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Bamboo Hanging Walls - Art</Link></li>
              <li><a href="https://ecobambo.com/collections/premium-bamboo-fence-panels-elegant-fence-wall-garden-fence-idea" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Bamboo Fence Panels- Decor</a></li>
              <li><Link href="/collections/1-modern-bamboo-hanging-wall-art-standing-plant-and-flower-pot-stylish-decor-perfect-for-home-garden/Flower-Pot" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Bamboo Flower Pots- Planters</Link></li>
              <li><a href="https://ecobambo.com/collections/bamboo-kids-chair" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Baby Furniture - Nursery Sets</a></li>
            </ul>
          </div>
          ...
          <div className="footer-block">
            ...
            <ul className="footer-block__details-content list-none p-0">
              <li><Link href="/pages/https-www-yourwebsite-com-about-us" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">About Eco Bambo - Our Story &amp; vision</Link></li>
              <li><Link href="/policies/shipping-policy" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Shipping &amp; Delivery Policy</Link></li>
              <li><Link href="/policies/terms-of-service" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Terms &amp; Conditions of Use</Link></li>
              <li><Link href="/pages/https-www-yourwebsite-com/contact-us" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Contact &amp; Customer Support</Link></li>
              <li><Link href="/policies/privacy-policy" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Privacy Policy &amp; Data Protection</Link></li>
              <li><Link href="/policies/refund-policy" className="link text-base text-[#b8860b] hover:text-amber-400 underline font-normal">Refund Policy &amp; Customer Satisfaction</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-block--newsletter flex justify-center space-x-6 mb-8">
          <ul className="list-none p-0 flex space-x-6" role="list">
            <li className="list-social__item">
              <a href="https://www.facebook.com/share/1EVwQs5T9X/?mibextid=wwXIfr" className="link list-social__link text-[#b8860b]" aria-label="Facebook">
            ...
            <li className="list-social__item">
              <a href="https://www.instagram.com/ecobambo0?igsh=a3dpZ3NiY2R6d3Uw&utm_source=qr" className="link list-social__link text-[#b8860b]" aria-label="Instagram">
            ...
            <li className="list-social__item">
              <a href="https://www.youtube.com/channel/UCMEfaztIY2KxW6fFh_J8zmw" className="link list-social__link text-[#b8860b]" aria-label="YouTube">
            ...
            <li className="list-social__item">
              <a href="https://www.tiktok.com/@ecobambo0?_t=ZS-8uYnW51R4Sb&_r=1" className="link list-social__link text-[#b8860b]" aria-label="TikTok">

      ...
      <div className="eco-form-container bg-black shadow-lg rounded-xl p-2 md:p-4 flex flex-col lg:flex-row lg:space-x-10 w-full mb-8 text-left">
        ...
        <div className="eco-form-right lg:w-1/2">
          ...
          <form method="post" action="/contact#contact_form" id="contact_form" acceptCharset="UTF-8" className="space-y-4">
            ...
            <select name="contact[collection]" required className="w-full bg-[#181818] text-[rgb(184,134,11,1)] border border-[#333] rounded px-4 py-2 mb-2 focus:outline-none focus:border-amber-400">
